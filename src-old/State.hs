...
instance Show GameState where
  show Game{ pacmanMounth=m, bufferMov=mov , pacman=p, ghosts=g} =
    show m ++ show mov ++ show p
...
initialState = Game
  ...
  where
    ghost1 = setPosition initialGhost (12, 3)
    ghost2 = setPosition initialGhost (13, 3)
    ghost3 = setPosition initialGhost (14, 3)
    ghost4 = setPosition initialGhost (15, 3)
