...
selectTarget :: Int -> Ghost.Ghost -> Pacman.Pacman-> (Int, Int)
selectTarget 0 gh pman = target
  where
    target = Pacman.position pman

selectTarget 1 gh pman = (nextNspaces 4 pos dir)
  where
    dir = Pacman.direction pman
    pos = Pacman.position pman

selectTarget 2 gh pman = target
  where
    dir = Pacman.direction pman
    pos = Pacman.position pman
